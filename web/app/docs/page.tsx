        ...
        <section className="docs-section">
          ...
          <div className="docs-steps-grid">
            <div className="docs-card">
              ...
              <p>Вы описываете проблему текстом или диктуете в микрофон. Модель Microsoft MAI Transcribe 2 транскрибирует запись, а ИИ-аналитик выделяет ценностное предложение, аудиторию и ограничения.</p>
            </div>
